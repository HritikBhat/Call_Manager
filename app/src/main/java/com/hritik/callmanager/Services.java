...
public class Services extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        try {
            Cursor cursor =dpHelper.alldata("Services");
            while(cursor.moveToNext()) {
                services.add(cursor.getString(cursor.getColumnIndex("name")));
        ...
        adapter = new ArrayAdapter<String>(this, R.layout.list_item, R.id.product_name, services);
        ...
        inputSearch.addTextChangedListener(new TextWatcher() {
            ...
            public void onTextChanged(CharSequence cs, int arg1, int arg2, int arg3) {
                ...
                Services.this.adapter.getFilter().filter(cs);
            }
